<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <svg width="50" viewBox="0 0 380 390" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      <defs>
        <style>
          .cls-1 {
            fill: #e24329;
    ...
    <span class="app-brand-text demo menu-text fw-bolder ms-2">snfx.us</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="?us=pengaduan" class="menu-link">
    ...
    <li class="menu-item">
      <a href="?us=verifikasi" class="menu-link">
        <i class="menu-icon tf-icons bx bx-loader"></i>
        <div data-i18n="Authentications">Verifikasi</div>
      </a>
    </li>
    <li class="menu-header small text-uppercase">
    ...
    <li class="menu-item">
      <a href="?us=tanggapan" class="menu-link">
        <i class="menu-icon tf-icons bx bx-loader"></i>
    ...
    <li class="menu-item">
      <a href="?us=password-check" class="menu-link">
        <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
        <div data-i18n="Authentications">Password Check</div>
      </a>
    </li>
</aside>
<!-- Navbar -->
      ...
      <div class="navbar-nav align-items-center">
        <div class="nav-item d-flex align-items-center">
          ...
          <form action="" method="post">
            <input type="text" name="keywoard" class="form-control border-0 shadow-none" placeholder="Search..." aria-label="Search..." id="keyword" autocomplete="off" />
        </div>
      </div>
      <!-- /Search -->
          ...
          <ul class="dropdown-menu dropdown-menu-end py-0">
            <li class="dropdown-menu-header border-bottom">
              <div class="dropdown-header d-flex align-items-center py-3">
                ...
                <a href="p" class="dropdown-notifications-all text-body" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark all as read"><i class="bx fs-4 bx-envelope-open"></i></a>
              </div>
            </li>
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="avatar avatar-online">
              <img src="../assets/svg/sandi.svg" alt class="w-px-40 h-auto rounded-circle">
            </div>
          </a>
          <ul class="dropdown-menu dropdown-menu-end">
              ...
              <a class="dropdown-item" href="">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    $akun = mysqli_fetch_assoc($petugas);
                    ?>
                    <span class="fw-semibold d-block"><?= ucwords($_SESSION['username']) ?></span>
            ...
            <li>
              <a class="dropdown-item" href="?us=profile">
