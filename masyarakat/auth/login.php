...
header('Expires: Wed, 31 Dec 2030 23:59:59 GMT');
// ? Ubah tanggal kedaluwarsa menjadi sesuatu yang sesuai
    ...
    <div class="authentication-basic">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- /Logo -->
          <!-- <h4 class="mb-2">Login Untuk Pengaduan 🚀</h4>
            <p class="mb-4">Bila Tidak Memiliki Akun Bisa Registrasi!</p> -->
          <?php
          if (isset($_POST['loginAkunMasyarakat'])) {
            if (loginAkunMasyarakat($_POST) > 0) {
          ...
          <form id="formAuthentication" class="mb-4" action="" method="POST">
            ...
            <div class="mb-3">
              <button class="btn btn-danger d-grid w-100" type="submit" name="loginAkunMasyarakat">Login</button>
            </div>
